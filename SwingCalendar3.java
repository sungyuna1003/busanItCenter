...
public class SwingCalendar3 extends JFrame implements ActionListener {
	...
	Calendar now;
	int year, month, date;
	Mate myc;//---> 여기 나의 class 명으로 수정해야함


	
	public SwingCalendar3(Mate mate) {
		this.myc = mate;
