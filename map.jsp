...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=9d998a289b03357b5e4403f9bd48c81d"></script>
<script>
...
var content = '<div class="wrap">' + 
            ...
            '        <div class="body">' + 
            '            <div class="img">' +
            '                <img src="https://www.visitbusan.net/<%=main_img_thumb%>" width=83 height=64>' +
            '           </div>' + 
            '            <div class="desc">' + 
            '                <div class="ellipsis"><%=addr1%></div>' + 
            '                <div class="jibun ellipsis"><%=cntct_tel%></div>' + 
            '                <div><a href="<%=homepage_url%>" target="_blank" class="link">홈페이지</a></div>' + 
            '            </div>' + 
            '        </div>' + 
            '    </div>' +    
            '</div>';
