...
public class SwingCalendar4 extends JFrame implements ActionListener {
	...
	Calendar now;
	int year, month, date;
	Signin myc;//---> 여기 나의 class 명으로 수정해야함


	
	public SwingCalendar4(Signin signin) {
		this.myc = signin;
